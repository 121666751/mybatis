...
public class CoreInsertElementGenerator extends BaseXmlElementGenerator {
	public CoreInsertElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		while (iter.hasNext()) {
			...
			valuesClause
					.append(isDateLastMainColumn(introspectedColumn) ? SYSDATE
