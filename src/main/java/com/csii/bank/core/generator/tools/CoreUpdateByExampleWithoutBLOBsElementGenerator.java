...
public class CoreUpdateByExampleWithoutBLOBsElementGenerator extends
		BaseXmlElementGenerator {
	public CoreUpdateByExampleWithoutBLOBsElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		while (iter.hasNext()) {
			...
			sb.append(isDateLastMainColumn(introspectedColumn) ? SYSDATE
					: Ibatis2FormattingUtilities.getParameterClause(
